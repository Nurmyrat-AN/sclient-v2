        ...
        <DateContainer onChange={({ date1, date2 }) => {
            ...
            <TableCell colSpan={colSpan} align='center'>
                <div style={{ display: 'flex', whiteSpace: 'nowrap', alignItems: 'center', justifyContent: 'center' }}>
                    <TextField style={{ width: 140 }} size='small' inputRef={startDateRef} defaultValue={homePage ? undefined : query.startdate || today1} name='startdate' type='date' />
                    <Typography variant='button' style={{ margin: '0 4px' }}>-</Typography>
                    <TextField style={{ width: 140 }} size='small' inputRef={endDateRef} defaultValue={homePage ? undefined : query.enddate || today2} name='enddate' type='date' />
                </div>
            </TableCell>
        </DateContainer>
